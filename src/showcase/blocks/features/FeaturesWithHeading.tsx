...
const FeaturesData: Feature[] = [
  {
    ...
    name: 'Easy to Use',
    description:
      'SyntaxUi Clone components are designed to be intuitive and easy to use, even for beginners.',
  ...
  },
  {
    ...
    name: 'Customizable',
    description:
      'Customize the look and feel of SyntaxUi Clone components to match your brand and design.',
  ...
  },
  {
    ...
    description:
      'SyntaxUi Clone is built with developers in mind, providing a clean and consistent API.',
  ...
  },
  {
    ...
    name: 'Responsive',
    description:
      'SyntaxUi Clone components are designed to be responsive and work seamlessly across devices.',
  ...
  },
  {
    ...
    name: 'Accessible',
    description:
      'SyntaxUi Clone prioritizes accessibility, ensuring that your components are usable by everyone.',
  ...
  },
  {
    ...
    description:
      'SyntaxUi Clone is actively maintained and regularly updated with new features and improvements.',
  ...
  return (
    <div className="my-12 flex w-full flex-col items-center justify-center">
      <h1 className="mb-2 max-w-3xl text-center text-2xl font-semibold tracking-tighter text-gray-900 md:text-3xl dark:text-gray-100">
        SyntaxUi Clone is not like any other component library.
      </h1>
      <p className="max-w-sm text-center text-sm text-gray-600 dark:text-gray-400">
        SyntaxUi Clone is a free to use, customizable, and highly customizable

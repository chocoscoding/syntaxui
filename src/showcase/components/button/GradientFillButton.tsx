const GradientFillButton = () => {
  return (
    <button className="group/button border-red-500/20 relative overflow-hidden rounded-md border bg-white px-4 py-1 text-xs font-medium text-red-500 transition-all duration-150 hover:border-red-500 active:scale-95">

const StitchesButton = () => {
  return (
    <button className="hover:shadow-red-500/50 group relative rounded-lg border-2 border-red-500 bg-red-500 px-5 py-1 font-medium text-white duration-1000 hover:shadow-lg">
